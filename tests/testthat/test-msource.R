...
test_that("msource29: mclear() works as expected.", {
...
test_that("msource30: mput() works as expected.", {
...
test_that("msource31: mget() works as expected.", {
...
test_that("msource32: mset() works as expected.", {
