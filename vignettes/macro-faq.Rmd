...
### Can I create macro functions? {#function}

**Q:** I want to create a macro function.  Does the
**macro** package support it?  


**A:** No.  Base R provides true function capabilities, and nothing
would be gained by replicating that capability with macro functions. 
It is recommended to use those existing features.
