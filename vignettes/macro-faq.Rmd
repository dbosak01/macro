...
* Macro Variables
* Macro Conditions
* Macro System Function
* Macro Include

These features are the most essential features of the SAS macro language,
and are missing from R.  Other features are not needed
for the primary use case of code generation, and are better handled using
standard R code.
...
directives.  These directives are resolved by the pre-processor function
...
### Can I create macro functions and do loops? {#function}

**Q:** I want to create a macro function.  Does the
**macro** package support it?  What about macro do loops?


**A:** No.  Base R provides true function capabilities, and nothing
would be gained by replicating that capability with macro functions.  Likewise
with do loops, there are already extensive features in Base R and Tidyverse
for looping.  It is recommended to use those existing features.
...
**A:** Yes. The package supports nest conditionals.  There is no
...
The advantages of using the **macro** package for code generation are:
