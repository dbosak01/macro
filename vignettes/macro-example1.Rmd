...
Generating the code makes it more readable and more compact.  Note that this example 
...
rpt <- create_report(out_pth, font = "Courier", output_type = "RTF") |> 
  page_header("Sponsor: sponsor.", "Study: study.") |> 
  titles(titles.) |> 
...
programs will be greatly appreciated by anyone who needs to review the code.
...
Next: [Example 2: Table](macro-example2.html)
