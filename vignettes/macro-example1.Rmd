...
#%let study_name <- ABC
#%let prog_name <- l_dm
#%let base_dir <- ./macro/tests/testthat/examples
...
```
Notice in the above code that there are several macro variables.  They start 
with an ampersand ("&") and sometimes end
