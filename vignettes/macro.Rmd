...
7. **Macro User-Defined Functions**: The ability to create a user-defined  
...
One difference is that in R, special 
characters are normally not allowed in variable names.  
