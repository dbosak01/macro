...
Need something here as a transition.
...
For comprehensive documentation on the R macro language commands, see the 
...
Additional information about the `msource()` function is available in the 
function reference.
...
[sassy](https://www.r-sassy.org) system of packages.
